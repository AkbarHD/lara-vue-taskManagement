        ...
        <div>
                ...
                <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div class="mr-auto place-self-center lg:col-span-7">
                        <h1
                            ...
                            Task Management Tools For Your Projects</h1>
                        <p
            ...
            <div class="flex justify-center mt-10 gap-10">
                <div class="mb-8 w-1/2">
                    <input type="text" class="p-2 border border-gray-300 rounded-md w-full"
                        placeholder="Search Projects.." name="" id="">
                </div>
                <div class="">
                    <Link :href="'/projects/create'">
                    <button type="button" class="text-white bg-blue-600 h-10 px-4 rounded hover:bg-blue-800">Create
                        Project</button>
                    </Link>
                </div>
            </div>
